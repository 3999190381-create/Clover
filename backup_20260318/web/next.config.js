...
const nextConfig = {
  ...
  typedRoutes: true,
  reactCompiler: true,
  // Disable font optimization to avoid Google Fonts fetch during Docker build
  // Note: optimizeFonts was removed in Next.js 15+, font optimization is handled automatically
  images: {
    remotePatterns: [
      {
        protocol: "https",
  ...
  // Note: i18n config removed - App Router uses next-intl via middleware
  // i18n locales are configured in src/i18n/request.ts
  async headers() {
